...
import br.com.diegomunhoz.core.SpriteAnimation;
...
public class JogoQuedaLivre extends Game {
    ...
    SpriteAnimation imgPterodatilo;
    ...
    public void onLoad() {
        try {
            ...
            imgCenario
                    = ImageManager.getInstance().loadImage("exemplo01/cenario.png");
            imgPterodatilo = ImageManager.getInstance().loadSpriteAnimation(
                    "exemplo01/pterodatilo.png", 5);
            imgPterodatilo.setLoop(true);
            imgCaindo = ImageManager.getInstance().loadImage(
                    "exemplo01/caindo.png");
            imgAcerto = ImageManager.getInstance().loadImage("exemplo01/acerto.png");
            imgErro = ImageManager.getInstance().loadImage("exemplo01/erro.png");
            sndPterodatilo = AudioManager.getInstance().loadAudio(
                    "exemplo01/aviao.wav");
            sndCaindo = AudioManager.getInstance().loadAudio("exemplo01/caindo.wav");
            sndAcerto = AudioManager.getInstance().loadAudio("exemplo01/acerto.wav");
            sndErro = AudioManager.getInstance().loadAudio("exemplo01/erro.wav");
    ...
    public void onUpdate(int currentTick) {
        ...
        imgPterodatilo.update(currentTick);
    }
    ...
    protected void renderJogo(Graphics2D g) {
        ...
        g.drawImage(imgPterodatilo.getImage(), posPtero.x, posPtero.y, null);
    }
